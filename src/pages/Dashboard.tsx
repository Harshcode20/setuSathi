      ...
      <ScrollView style={styles.scroll} contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View style={styles.header}>
          <View style={styles.headerRow}>
            <View style={styles.headerLeft}>
              <View style={styles.headerLogo}><Text style={styles.headerLogoText}>S</Text></View>
        ...
        <View style={styles.profileCardOuter}>
          <View style={styles.profileCard}>
            <View style={styles.profileAvatar}><Text style={styles.profileAvatarText}>DD</Text></View>
            <View style={styles.profileInfo}>
              <Text style={styles.profileId}>S1234</Text>
              <Text style={styles.profileName}>Dalpatbhai Dave</Text>
...
const styles = StyleSheet.create({
  ...
  headerLogo: { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(255,255,255,0.2)', alignItems: 'center', justifyContent: 'center' },
  headerLogoText: { color: '#fff', fontWeight: 'bold', fontSize: 18 },
  ...
  profileAvatar: { width: 72, height: 72, borderRadius: 14, backgroundColor: '#e5e7eb', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#e2e2e2' },
  profileAvatarText: { fontSize: 24, fontWeight: 'bold', color: '#555' },
